...
internal class TerminalScreenState(
     ...
     *
     * When the scrollback buffer shrinks (e.g. max lines reduced), [scrollbackPosition] is
     * clamped so the viewport stays valid and the user is not left past the oldest line.
     *
