...
object DatabaseModule {
    ...
    fun provideConnectBotDatabase(@ApplicationContext context: Context): ConnectBotDatabase = Room.databaseBuilder(
        ...
        .addMigrations(ConnectBotDatabase.MIGRATION_4_5, ConnectBotDatabase.MIGRATION_7_8, ConnectBotDatabase.MIGRATION_8_9, ConnectBotDatabase.MIGRATION_9_10, ConnectBotDatabase.MIGRATION_10_11, ConnectBotDatabase.MIGRATION_11_12, ConnectBotDatabase.MIGRATION_12_13, ConnectBotDatabase.MIGRATION_13_14, ConnectBotDatabase.MIGRATION_14_15)
    ...
    @Provides
    fun providePromptTemplateDao(database: ConnectBotDatabase): PromptTemplateDao = database.promptTemplateDao()
}
