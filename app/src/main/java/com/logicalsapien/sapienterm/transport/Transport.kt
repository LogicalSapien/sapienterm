...
sealed class Transport {
    ...
    object Telnet : Transport() {
        ...
        override fun getFormatHint(context: Context): String = com.logicalsapien.sapienterm.transport.Telnet.getFormatHint(context)

        override fun createInstance(): AbsTransport = com.logicalsapien.sapienterm.transport.Telnet()

        override fun parseUri(input: String): Uri? = com.logicalsapien.sapienterm.transport.Telnet.getUri(input)
    }
    ...
    object Local : Transport() {
        ...
        override fun getFormatHint(context: Context): String = com.logicalsapien.sapienterm.transport.Local.getFormatHint(context)

        override fun createInstance(): AbsTransport = com.logicalsapien.sapienterm.transport.Local()

        override fun parseUri(input: String): Uri? = com.logicalsapien.sapienterm.transport.Local.getUri(input)
    }
