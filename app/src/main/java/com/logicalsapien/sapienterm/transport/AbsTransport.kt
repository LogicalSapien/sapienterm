...
abstract class AbsTransport {
    ...
    /**
     * Upload a small user-selected file to the remote account and return the remote path
     * that should be pasted into the terminal. Transports that cannot upload return null.
     */
    @Throws(IOException::class)
    open fun uploadTerminalAttachment(bytes: ByteArray, filename: String): String? = null
