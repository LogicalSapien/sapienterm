 ...
 * @return Boolean response from user, null if cancelled/disconnected
 */
fun TerminalBridge.requestBooleanPrompt(
    ...
    return try {
        ...
        Timber.w("Boolean prompt cancelled (bridge disconnected or stream closed).")
        return null
    }
}
 ...
 * @return String response from user, or null if cancelled/disconnected
 */
fun TerminalBridge.requestStringPrompt(
    ...
    return try {
        ...
        Timber.w("String prompt cancelled (bridge disconnected or stream closed).")
        return null
    }
}
...
fun TerminalBridge.requestBiometricAuth(
    ...
    return try {
        ...
        Timber.w("Biometric prompt cancelled (bridge disconnected or stream closed).")
        return false
    }
}
 ...
 * @return Boolean response from user, or null if cancelled/disconnected
 */
fun TerminalBridge.requestHostKeyFingerprintPrompt(
    ...
    return try {
        ...
        Timber.w("Host key prompt cancelled (bridge disconnected or stream closed).")
        return null
    }
}
