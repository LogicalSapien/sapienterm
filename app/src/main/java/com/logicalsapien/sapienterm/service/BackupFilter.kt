...
class BackupFilter(
                ...
                if (!scheme.isBuiltIn) {
                    ...
                    colors.forEachIndexed { index, color ->
                        tempDb.colorSchemeDao().insertColor(
                            com.logicalsapien.sapienterm.data.entity.ColorPalette(
                                schemeId = scheme.id,
                                colorIndex = index,
                                color = color
                            )
     ...
     */
    fun filterBackupablePubkeys(pubkeys: List<com.logicalsapien.sapienterm.data.entity.Pubkey>): List<com.logicalsapien.sapienterm.data.entity.Pubkey> = pubkeys.filter { pubkey ->
