...
// ── Light Theme Colors ──
val md_theme_light_primary = Color(0xFF00796B)            // Darker Teal - visible on white
val md_theme_light_onPrimary = Color(0xFFFFFFFF)
val md_theme_light_primaryContainer = Color(0xFFB2DFDB)
val md_theme_light_onPrimaryContainer = Color(0xFF002022)
val md_theme_light_secondary = Color(0xFF0D47A1)          // Darker Blue - visible on white
...
val md_theme_light_background = Color(0xFFF5F5F5)         // Slightly warm light background
val md_theme_light_onBackground = Color(0xFF1A1C1E)
val md_theme_light_surface = Color(0xFFFFFBFE)            // Near-white surface
