...
package com.logicalsapien.sapienssh.transport
...
sealed class Transport {
    ...
    object Telnet : Transport() {
        ...
        override fun getFormatHint(context: Context): String = com.logicalsapien.sapienssh.transport.Telnet.getFormatHint(context)

        override fun createInstance(): AbsTransport = com.logicalsapien.sapienssh.transport.Telnet()

        override fun parseUri(input: String): Uri? = com.logicalsapien.sapienssh.transport.Telnet.getUri(input)
    }
    ...
    object Local : Transport() {
        ...
        override fun getFormatHint(context: Context): String = com.logicalsapien.sapienssh.transport.Local.getFormatHint(context)

        override fun createInstance(): AbsTransport = com.logicalsapien.sapienssh.transport.Local()

        override fun parseUri(input: String): Uri? = com.logicalsapien.sapienssh.transport.Local.getUri(input)
    }
