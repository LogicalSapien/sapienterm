...
package com.logicalsapien.sapienssh.service

import android.content.Context
import androidx.room.Room
import com.logicalsapien.sapienssh.data.ColorSchemeRepository
import com.logicalsapien.sapienssh.data.ConnectBotDatabase
...
class BackupFilter(
                ...
                if (!scheme.isBuiltIn) {
                    ...
                    colors.forEachIndexed { index, color ->
                        tempDb.colorSchemeDao().insertColor(
                            com.logicalsapien.sapienssh.data.entity.ColorPalette(
                                schemeId = scheme.id,
                                colorIndex = index,
                                color = color
                            )
     ...
     */
    fun filterBackupablePubkeys(pubkeys: List<com.logicalsapien.sapienssh.data.entity.Pubkey>): List<com.logicalsapien.sapienssh.data.entity.Pubkey> = pubkeys.filter { pubkey ->
